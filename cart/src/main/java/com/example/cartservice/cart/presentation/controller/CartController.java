...
public class CartController {
    ...
    public ResponseEntity<CartResponse> getMyCart(
        ...
        CartResponse response = cartSearchUseCase.getMyCart(memberId);
    ...
    public ResponseEntity<CartResponse> addCartItem(
        ...
        CartResponse response = cartUpdateUseCase.addCartItem(memberId, request);
    ...
    public ResponseEntity<CartResponse> updateCartItem(
        ...
        CartResponse response = cartUpdateUseCase.updateCartItem(memberId, cartItemId, request);
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<CartResponse> deleteCartItem(
        ...
        CartResponse response = cartDeleteUseCase.deleteCartItem(memberId, cartItemId);
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<CartResponse> deleteCartItems(
        ...
        CartResponse response = cartDeleteUseCase.deleteCartItems(memberId, request);
        return ResponseEntity.ok(response);
    }
}
