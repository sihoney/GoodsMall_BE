...
INSERT INTO payment.charge (
    ...
    pg_provider, pg_order_id, pg_payment_key,
...
VALUES
    ('dd000001-0000-0000-0000-000000000001',
     ...
     'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa1',
     100000, 100000,
     'TOSS', 'test-pg-order-001', 'test_payment_key_001',
     'SUCCESS',
    ...
    ('dd000002-0000-0000-0000-000000000002',
     ...
     'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa1',
     50000, 50000,
     'TOSS', 'test-pg-order-002', 'test_payment_key_002',
     'SUCCESS',
...
INSERT INTO payment.escrow (
    ...
    amount, escrow_status,
    refunded_at, released_at, release_at,
